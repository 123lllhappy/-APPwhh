...
public final class ItemContactBinding implements ViewBinding {
  ...
  private ItemContactBinding(@NonNull LinearLayout rootView, @NonNull TextView tvContactName,
      @NonNull TextView tvContactPhone, @NonNull TextView tvDelete) {
  ...
  public static ItemContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContactBinding((LinearLayout) rootView, tvContactName, tvContactPhone,
          tvDelete);
    }
