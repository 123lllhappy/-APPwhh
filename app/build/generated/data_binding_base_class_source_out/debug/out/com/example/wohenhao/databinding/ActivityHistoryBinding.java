...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  private ActivityHistoryBinding(@NonNull LinearLayout rootView, @NonNull MaterialToolbar toolbar,
      @NonNull TextView tvEmpty, @NonNull TextView tvHistoryList) {
    this.rootView = rootView;
    this.toolbar = toolbar;
    this.tvEmpty = tvEmpty;
    this.tvHistoryList = tvHistoryList;
  }
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_history_list;
      TextView tvHistoryList = ViewBindings.findChildViewById(rootView, id);
      if (tvHistoryList == null) {
        break missingId;
      }

      return new ActivityHistoryBinding((LinearLayout) rootView, toolbar, tvEmpty, tvHistoryList);
    }
